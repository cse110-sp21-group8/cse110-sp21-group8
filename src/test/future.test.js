...
describe('CRUD test for future page:', () => {
    describe('Test: add Subtasks', () => {
        ...
        sendData = {status:"future", content:"SubTask Content", date:new Date().toDateString(),type:"task",task_id:"60aad95c93b4e511484c5333"};
        request(app)
        ...
        //send the request
        //task_id: parent task id
        sendData = {old:{status:"future", content:"SubTask Content", date:new Date().toDateString(),type:"task",task_id:"60aad95c93b4e511484c5333"},
                    new:{status:"future", content:"SubTask Content Modification", date:new Date().toDateString(),type:"task",task_id:"60aad95c93b4e511484c5333"}};
        request(app)
        ...
        //send the request
        //task_id: parent task id
        sendData = {status:"future", content:"SubTask Content Modification", date:new Date().toDateString(),type:"task",task_id:"60aad95c93b4e511484c5333"};
        request(app)
