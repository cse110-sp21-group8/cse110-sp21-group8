      ...
      if (data['status'] == 200) {
        ...
        tasks.forEach((tmp) => {
          ...
          item.addEventListener('click', () => {
            ...
            c_tags_content.innerText =
              CustomsList[item.getAttribute('index')]['tags'];
