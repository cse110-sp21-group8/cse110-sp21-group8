...
document.addEventListener('DOMContentLoaded', () => {
  //function init(){
  document.querySelector('.whole-cal1 h2').innerHTML =
    months[date.getMonth() % 12];
  document.querySelector('.whole-cal2 h2').innerHTML =
    months[(date.getMonth() + 1) % 12];
  document.querySelector('.whole-cal3 h2').innerHTML =
    months[(date.getMonth() + 2) % 12];
  document.querySelector('.whole-cal4 h2').innerHTML =
    months[(date.getMonth() + 3) % 12];
  document.querySelector('.whole-cal5 h2').innerHTML =
    months[(date.getMonth() + 4) % 12];
  document.querySelector('.whole-cal6 h2').innerHTML =
    months[(date.getMonth() + 5) % 12];
  //}
  //window.onload = init();
